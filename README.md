...
3. **导入自己的生词过于困难** — 所有的软件都强调背词书，但我不想要背词书呢？我只想背自己笔记里的单词，
...
> "之前考托业的时候，忙着过年忘记了备考，直到考前两周才意识到时间快来不及了。
   Gemini告诉我最有效率的方法是整理每一张模拟卷不认识的单词，全背下来。而我遍历了市面上的背单词软件，要么就是收费要么就是导入很多单词的时候十分麻烦。
   后来我想了个办法，就是每天晚上把今天记的单词放在notion里，晚上从上到下看一遍。到了第二周一百多个单词以后，效率已经低的吓人了。
   这种低下的效率我忍了整整两周。
   考完我痛定思痛，一定要做出一个网站解决这件事情。"
